import {
    ...
    notificationsAtom, selectedItemIdsAtom,
...
export default function DeclarationsPageHeader() {
    ...
    useEffect(() => {
        switch (currentTabIndex) {
            case 0:
                setTitle(isInSelectionMode ? 'Selecteer bonnen' : 'Mijn bonnen');
                break;
            case 1:
    ...
    return <>
        ...
        <header className={`flex sticky top-0 flex-col transition-all duration-500 ease-in-out ${backgroundColor} p-4 py-8 pt-16 gap-4 z-10`}>
